    ...
    actions: {
        async getArticles(params){
            ...
            try {
                ...
                const response = await http.get('/api/'+indexStore.app+'/articles', urlParams);
        ...
        async getArticle(id){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/'+indexStore.app+'/articles/'+id);
        ...
        async getArticleTypes(params){
            ...
            try {
                const urlParams = parseFilterParams(params);             
                const response = await http.get('/api/'+indexStore.app+'/article-types', urlParams);
