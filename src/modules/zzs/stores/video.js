    ...
    actions: {
        async getVideos(params){
            ...
            try {
                ...
                const response = await http.get('/api/'+indexStore.app+'/videos', urlParams);
        ...
        async getVideo(id){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/'+indexStore.app+'/videos/'+id);
        ...
        async downloadFile(id){
            ...
            indexStore.setLoading();
            try {            
                await downloadFile('/api/'+indexStore.app+'/videos/download-file/'+id);
                indexStore.setLoading(false);
            } catch (error) {
                if(env === 'local' || env === 'dev'){
                    console.log(error);
