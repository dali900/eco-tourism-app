    ...
    actions: {
        async getQuestions(params){
            ...
            try {
                ...
                const response = await http.get('/api/'+indexStore.app+'/questions', urlParams);
        ...
        async getQuestion(id){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/'+indexStore.app+'/questions/'+id);
        ...
        async getQuestionTypes(params){
            ...
            try {
                const urlParams = parseFilterParams(params);             
                const response = await http.get('/api/'+indexStore.app+'/question-types', urlParams);
