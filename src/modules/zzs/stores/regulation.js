    ...
    actions: { 
        ...
        async getRegulationTypes(params){
            ...
            try {
                ...
                const response = await http.get('/api/'+indexStore.app+'/regulation-types', urlParams);
        ...
        async getRegulationRootTypes(params){
            ...
            try {
                const urlParams = parseFilterParams(params);
                const response = await http.get('/api/'+indexStore.app+'/regulation-types/roots', urlParams);
        ...
        async getRegulations(params){
            ...
            try {
                const urlParams = parseFilterParams(params);             
                const response = await http.get('/api/'+indexStore.app+'/regulations', urlParams);
        ...
        async getRegulation(id){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/'+indexStore.app+'/regulations/'+id);
        ...
        async downloadFile(id){
            ...
            indexStore.setLoading();
            try {            
                await downloadFile('/api/'+indexStore.app+'/regulations/download-file/'+id);
                indexStore.setLoading(false);
            } catch (error) {
                if(env === 'local' || env === 'dev'){
                    console.log(error);
