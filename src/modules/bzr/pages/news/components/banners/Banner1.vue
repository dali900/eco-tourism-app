<template>
    <div class="contact p-3">
        <div class="banner flex justify-content-center">
            ...
            <div class="title">{{ banner ? banner.title : 'Online BZR panel' }}</div>
        </div>
                ...
                <template #content>
                    <div class="grid">
                        ...
                        <!-- <div class="field col-12 md:col-12 lg:col-12 text-center">
                            <b>PRVA NACIONALNA KONFERENCIJA</b>
                        </div>
                        <div class="field col-12 md:col-12 lg:col-12 flex justify-content-center">
                            <table class="contact-price-table">
                                <tr>
                                    <th>PRETPLATNICI BZR PORTALA</th>
                                    <th>NEPRETPLATNICI</th>
                                </tr>
                                <tr>
                                    <td>UŽIVO: 5.900 RSD + PDV</td>
                                    <td>UŽIVO: 15.900 RSD + PDV</td>
                                </tr>
                                <tr>
                                    <td>ONLINE: 3.900 RSD + PDV</td>
                                    <td>ONLINE: 11.900 RSD + PDV</td>
                                </tr>
                            </table>
                        </div> -->
                        <!-- <div class="field col-12 md:col-12 lg:col-12 text-center">
                            <small>
                                * Broj kotizacija po povlašćenoj ceni, za učešće pretplatnika na Konferenciji određuje se prema broju
                                korisničkih licenci BZR portala (1 licenca – 1 učesnik). Nakon prijave pretplatnika na konferenciju, svaki
                                naredni učesnik (iz istog pravnog lica) snosi iznos kotizacije u visini od 3.900 rsd + pdv za online i 9.900
                                rsd + pdv za uživo učešće. Nepretplatnici ostvaruju popust od 10% od iznosa kotizacije za svakog 3 i
                                narednog učesnika.
                            </small>
                        </div> -->
...
import { useUserStore } from '@bzr/stores/user'
import { useBannerStore } from '@bzr/stores/banner'
