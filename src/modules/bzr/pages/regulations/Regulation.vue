                ...
                <div class="col-12 md:col-4 lg:col-4">
                    <div class="flex flex-wrap">
                        ...
                        <div v-if="regulation.text_start_date_formated" class="field">
                            <div class="label">Datum stupanja na snagu osnovnog teksta propisa</div>
                        ...
                        <div v-if="regulation.basis" class="field">
                            <div class="label">Norma osnova za donošenje</div>
...
<script setup>
import { ref, reactive, watch, onMounted, onBeforeMount, onUnmounted, computed } from 'vue'
import { storeToRefs } from 'pinia'
import { useRouter, useRoute } from 'vue-router'
import { useToast } from "primevue/usetoast";
import { FilterMatchMode } from 'primevue/api';
import { useRegulationStore } from '@bzr/stores/regulation'
