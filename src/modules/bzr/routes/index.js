    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: "zakon-o-bezbednosti-i-zdravlju-na-radu/",
                    name: "NewLaw",
                    component: () => import("../pages/NewLaw.vue")
                },
                {
                    path: "prezentacije-bzr-konferencija/",
                    name: "Presentations",
                    component: () => import("../pages/conference/Presentations.vue")
                },
            ],
        },
        {
