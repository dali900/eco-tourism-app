    ...
    actions: {
        ...
        async getDocumentTypes(params){
            ...
            try {
                ...
                const response = await http.get('/api/bzr/document-types', urlParams);
        ...
        async getDocuments(params){
            ...
            try {
                const urlParams = parseFilterParams(params);
                const response = await http.get('/api/bzr/documents', urlParams);
        ...
        async getDocument(id){
            ...
            indexStore.setLoading();
            try {         
                const response = await http.get('/api/bzr/documents/'+id);
        ...
        async downloadFile(id){
            ...
            indexStore.setLoading();
            try {            
                await downloadFile('/api/bzr/documents/download-file/'+id);
                indexStore.setLoading(false);
            } catch (error) {
                if(env === 'local' || env === 'dev'){
                    console.log(error);
