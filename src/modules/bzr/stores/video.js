    ...
    actions: {
        async getVideos(params){
            ...
            try {
                ...
                const response = await http.get('/api/bzr/videos', urlParams);
        ...
        async getVideo(id){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/bzr/videos/'+id);
        ...
        async downloadFile(id){
            ...
            indexStore.setLoading();
            try {            
                await downloadFile('/api/bzr/videos/download-file/'+id);
                indexStore.setLoading(false);
            } catch (error) {
                if(env === 'local' || env === 'dev'){
                    console.log(error);
