<template>
    <div class="admin-document">
        <SubscriptionPlanForm v-model="showForm" :id="resourceId"></SubscriptionPlanForm>
        <!-- list -->
        <Card class="resource-list">
            <template #title>
                <span>Pretplatnički planovi</span> &nbsp;
            ...
            <template #content>
                ...
                >
                    ...
                    <Column field="interval" header="Interval" ref="interval" :style="mainColumnsWidth">
                        <template #body="{data}">
                            {{data.interval}}
                        </template>
                    </Column>
            ...
            <template #footer>
                <div class="flex justify-content-between">
                    <small>Total: {{subscriptionPlansTotal}}</small>
                </div>
            </template>
        </Card>
    </div>
...
import SubscriptionPlanForm from './components/SubscriptionPlanForm.vue'
