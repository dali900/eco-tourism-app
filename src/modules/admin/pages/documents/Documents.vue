    ...
    <div class="admin-document">
        ...
        <Card class="resource-list">
            <template #title>
                ...
                <router-link :to="{ name: 'AdminDocument'}" class="btn-link">
                    <Button icon="pi pi-plus" class="p-button-sm" v-tooltip="'Dodaj novi model akta'"/>
                </router-link>
            </template>
            <template #content>
                ...
                >
                    ...
                    <Column :exportable="false" style="min-width:10%">
                        <template #body="slotProps">
                            ...
                            <router-link :to="{ name: 'AdminDocument', params: { documentId: slotProps.data.id }}" class="btn-link">
            ...
            <template #footer>
                <div class="flex justify-content-between">
                    <small>Total: {{documentsTotal}}</small>
                </div>
            </template>
        </Card>
    </div>
...
const documentFilterTimer = ref(null);
...
const deleteResource = (id) => {
    documentStore.delete(id)
        .then(() => {
            toast.add({severity:'success', summary: 'Model akta obrisan.', life: 3000});
        })
        .catch(() => {
