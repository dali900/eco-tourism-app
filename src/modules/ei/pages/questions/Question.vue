        ...
        <div class="question-content" v-if="question">
            ...
            <div class="grid" v-if="authStore.hasActivePlan()">
                ...
                <div v-if="question.question" class="field col-12">
                    <div class="label" v-if="isMinistryOfFinanceCategory(question)">Službeno mišljenje</div>
                    <div class="label" v-else>Pitanje</div>
                    <div class="data" v-html="question.question"></div>
                </div>
                <div v-if="question.answer" class="field col-12">
                    <div class="label" v-if="isMinistryOfFinanceCategory(question)">Tekst</div>
                    <div class="label" v-else>Odgovor</div>
                ...
                <div v-if="question.question_type" class="field col-12 md:col-6 lg:col-4">
                    <div class="label">Kategorija pitanja i odgovora</div>
                    <div class="data">{{question.question_type.name}}</div>
                </div>
...
import { useQuestionStore } from '@ei/stores/question'
...
const isMinistryOfFinanceCategory = (question) => {
    return question.question_type && (question.question_type.name.includes('Ministarstva finansija'));
}
