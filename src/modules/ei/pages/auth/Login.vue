    ...
    <div class="login">
        <Card class="login-card">
            <template #title>
                ...
                <div class="grid">
                    <div class="left-grid">
                        <img loading="lazy" src="/images/exportinfo_red_logo.png" alt="" class="logo-app"/>
                    </div>
                    <div class="right-grid">
                        <span class="app-title"><b>EXPORT</b> INFO</span><br/>
                        <span class="app-name">Portal za spoljnu trgovinu</span>
                    </div>
                </div>
            </template>
            <template #content>
...
onBeforeMount( () => {
    ...
    if(isAuthenticated.value){
        ...
        if(routerPreviousUrl.value){
            console.log("push", {routerPreviousUrl});
...
<style lang="scss">
.login {
    background-image: url("/images/LOGIN_background_EI.png");
    ...
    .login-footer {
        ...
        .p-button {
            ...
            border-color: var(--color-exportinfo-navbar-background-primary);
        }
    }
}
</style>