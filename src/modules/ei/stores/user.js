...
export const useUserStore = defineStore('user', {
    ...
    actions: {
        ...
        async getUser(id){
            ...
            try {
                const response = await http.get('/api/exportinfo/users/'+id);
        ...
        async create(data, errorFields){
            ...
            indexStore.setLoading();
            try {            
                const response = await http.post('/api/exportinfo/users', data);
        ...
        async update(id, data, errorFields){
            ...
            indexStore.setLoading();
            try {            
                const response = await http.put('/api/exportinfo/users/'+id, data);
                const user = response.data.data.user;
                if(this.users && this.users.length){
        ...
        async updatePassword(id, data, errorFields){
            ...
            indexStore.setLoading();
            try {            
                const response = await http.put('/api/exportinfo/users/'+id+'/password', data);
                indexStore.setLoading(false);
                return response.data.data;
            } catch (error) {
                if(env === 'local' || env === 'dev'){
        ...
        async delete(id){
            ...
            indexStore.setLoading();
            try {            
                const response = await http.delete('/api/exportinfo/users/'+id);
        ...
        async contact(data, errorFields){
            ...
            indexStore.setLoading();
            try {            
                const response = await http.post('/api/exportinfo/contact', data);
                indexStore.setLoading(false);
                return response.data.data;
            } catch (error) {
                if(env === 'local' || env === 'dev'){
