    ...
    actions: { 
        ...
        async getRegulationTypes(params){
            ...
            try {
                ...
                const response = await http.get('/api/exportinfo/regulation-types', urlParams);
        ...
        async getRegulations(params){
            ...
            try {
                const urlParams = parseFilterParams(params);             
                const response = await http.get('/api/exportinfo/regulations', urlParams);
        ...
        async getRegulation(id){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/exportinfo/regulations/'+id);
        ...
        async downloadFile(id){
            ...
            indexStore.setLoading();
            try {            
                await downloadFile('/api/exportinfo/regulations/download-file/'+id);
                indexStore.setLoading(false);
            } catch (error) {
                if(env === 'local' || env === 'dev'){
                    console.log(error);
