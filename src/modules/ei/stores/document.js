    ...
    actions: {
        ...
        async getDocumentTypes(params){
            ...
            try {
                ...
                const response = await http.get('/api/exportinfo/document-types', urlParams);
        ...
        async getDocuments(params){
            ...
            try {
                const urlParams = parseFilterParams(params);
                const response = await http.get('/api/exportinfo/documents', urlParams);
        ...
        async getDocument(id){
            ...
            indexStore.setLoading();
            try {         
                const response = await http.get('/api/exportinfo/documents/'+id);
        ...
        async downloadFile(id){
            ...
            indexStore.setLoading();
            try {            
                await downloadFile('/api/exportinfo/documents/download-file/'+id);
                indexStore.setLoading(false);
            } catch (error) {
                if(env === 'local' || env === 'dev'){
                    console.log(error);
