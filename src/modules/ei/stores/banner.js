    ...
    actions: {
        async getBanners(params){
            ...
            try {
                ...
                const response = await http.get('/api/exportinfo/banners', urlParams);
        ...
        async getAllBanners(){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/exportinfo/banners/');
        ...
        async getBanner(id){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/exportinfo/banners/'+id);
        ...
        async getLeftBanner(){
            ...
            indexStore.setLoading();
            try {
                const response = await http.get('/api/exportinfo/banners/left-banner');
        ...
        async banner1Contact(data, errorFields){
            ...
            indexStore.setLoading();
            try {            
                const response = await http.post('/api/exportinfo/contact/banner-1', data);
                indexStore.setLoading(false);
                return response.data.data;
            } catch (error) {
                if(env === 'local' || env === 'dev'){
